  ...
  <html class="h-100" lang="es">
    <head>
        ...
        <script>
            ...
            posthog.init('phc_i157YJ3jaO48GuC9SHlkVc5J2ezHLiCgSb3PZLVBXOs',{api_host:'https://us.i.posthog.com', defaults:'2025-11-30'})
        </script>
    </head>
        ...
        <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                ...
                <div class="d-flex gap-2">
                    <a class="btn btn-outline-primary" href="/#mentoria">
                        <i class="bi-mortarboard-fill me-1"></i>Mentoría Tech
                    </a>
                ...
                <div class="row">
                    <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                        <ul class="list-inline mb-2">
                            ...
                            <li class="list-inline-item"><a href="/#mentoria">Mentoría Tech</a></li>
                            <li class="list-inline-item">⋅</li>

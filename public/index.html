...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.pragmore.com/2.0.0/solid/blouse.css?font=Poppins&size=16pt&family=sans-serif">
  <style>body:after{content:"BETA";position:fixed;width:150px;height:30px;background:#9bc90d;top:12px;right:-48px;text-align:center;font-size:14px;font-family:sans-serif;font-weight:700;color:#fff;line-height:35px;transform:rotate(45deg)}</style>
</head>
<body>
